...
\RequirePackage{tikz} % Required for \foreach (for loops) - used for skill circles
%----------------------------------------------------------------------------------------
%	DOCUMENT MARGINS
%----------------------------------------------------------------------------------------
...
%	COLOURS AND LINKS
%----------------------------------------------------------------------------------------
% FIXME - I commented out the line below as a test
...
\definecolor{skill_empty}{HTML}{e1bbbb} % Skill bubble empty
...
\newcommand{\workposition}[6]{
	\expandafter\ifstrequal\expandafter{#1}{}{}{{\raggedright\large\textbf{#1}}\\} % Job title
	\expandafter\ifstrequal\expandafter{#2}{}{}{{\raggedright\large #2}\\} % Employer
	{\raggedright\textsc{\normalsize\faCalendar\hspace{3pt}#3\expandafter\ifstrequal\expandafter{#5}{}{}{\hspace{20pt}{\faMapMarker\hspace{3pt}#4\hfill(#5)}}\\[4pt]}\par} % Duration, Location and conditional full time/part time text
...
% command to add rank boxes for skills. No longer used :(
\newcommand{\cvskill}[2]{%
\textcolor{black}{#1}\hfill
\foreach \x in {1,...,10}{%
  \space{\ifnumgreater{\x}{#2}{\color{skill_empty}}{\color{headings}}\faCircle}
  }\par%
}

% Add a box around text
\newcommand*{\mybox}[1]{\framebox{\strut\color{headings}#1}}
